...
cron.schedule("*/17 * * * * *", pollSorobanDepositEvents);
cron.schedule("*/17 * * * * *", pollSorobanWithdrawEvents);
cron.schedule("*/17 * * * * *", pollSorobanClaimEvents);
// Start listening on port 3000


app.listen(3003, () => console.log("Server is listening on port 3002."));