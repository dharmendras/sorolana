...
cron.schedule("*/18 * * * * *", pollSorobanDepositEvents);
cron.schedule("*/18 * * * * *", pollSorobanWithdrawEvents);
cron.schedule("*/18 * * * * *", pollSorobanClaimEvents);
// Start listening on port 3000


app.listen(3004, () => console.log("Server is listening on port 3002."));